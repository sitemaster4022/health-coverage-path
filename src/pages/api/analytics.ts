...
const allowedEvents = new Set(['page_view','page_cta_click','funnel_start','funnel_step_complete','funnel_abandon','lead_submit','lead_success','lead_duplicate','lead_failure','calculator_complete','trustedform_certificate_available','trustedform_certificate_missing']);
